...
const PLATFORM_COMMANDS: CommandItem[] = [
    ...
    { id: 'p-promotions', labelKey: 'admin:commandPalette.promotionsRemises', labelFallback: 'Promotions & Remises', descriptionKey: 'admin:commandPalette.promotionsRemisesDesc', descriptionFallback: 'Promotions multi-scopes, packages, cascade, coupons, réductions', path: '/platform/promotions', icon: Sparkles, category: 'platform', categoryKey: 'admin:commandPalette.catCommerce', categoryFallback: 'Commerce', keywords: ['promotions', 'remises', 'packages', 'cascade', 'multi-scopes', 'coupons', 'reductions', 'discounts', 'gratuite'] },
