...
const __originkitPresetProps = {
  "gridText": "e s                  elisaschool     gestion intélligente école  établissement  note   scolarité bulletin   ELISASCHOOL  E  L   I  S  A  Classe   gestion   note",
  "font": {
    "variant": "Extra Bold",
    "fontSize": 14,
    "textAlign": "left",
