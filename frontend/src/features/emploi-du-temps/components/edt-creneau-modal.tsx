...
import type { CreneauHoraire, JourSemaine, TypeCreneau, DonneesVerification, Conflit } from '../hooks/use-emploi-du-temps';
...
export function EDTCreneauModal({ open, onOpenChange, creneau, affectationMatiereId, etablissementId, onSuccess }: EDTCreneauModalProps) {
            ...
            <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="h-10 w-20 rounded-lg border border-[var(--color-bordure)] cursor-pointer"
                            />
                        </div>
                    </div>
                )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-lg border border-[var(--color-bordure)] px-3 py-2 text-sm bg-[var(--color-surface)] text-[var(--color-texte)]"
                                    placeholder="ID salle (optionnel)"
                                />
                            </div>
                        </div>
                ...
                {step === 3 && (
                    <div className="space-y-4">
                        ...
                        <div className="rounded-lg border border-[var(--color-bordure)] bg-[var(--color-surface-alt)] p-4 space-y-2 text-sm">
                            <div className="flex justify-between">
                                <span className="text-[var(--color-texte-secondaire)]">{t('creneau.modal.jour')} :</span>
                                <span className="font-medium">{t(`jours.${form.jour.toLowerCase()}`)}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-[var(--color-texte-secondaire)]">{t('creneau.modal.horaire')} :</span>
                                <span className="font-mono font-medium">{form.heureDebut} — {form.heureFin}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-[var(--color-texte-secondaire)]">{t('creneau.modal.typeCreneau')} :</span>
                                <span className="font-medium">{t(`creneau.types.${form.typeCreneau.toLowerCase()}`)}</span>
                            </div>
                            {form.salleId && (
                                <div className="flex justify-between">
                                    <span className="text-[var(--color-texte-secondaire)]">{t('creneau.modal.salle')} :</span>
                ...
                {/* Navigation */}
                <div className="flex items-center justify-between pt-4 border-t border-[var(--color-bordure)]">
                    <ElisaButton
                        variant="ghost"
