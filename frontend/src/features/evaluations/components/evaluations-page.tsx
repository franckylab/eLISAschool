...
export function EvaluationsPage() {
    ...
    const colonnes = [
        ...
        { key: 'actions', header: 'Actions', className: 'w-32', render: (e: any) => <button className="text-blue-600 hover:underline text-sm">Voir détails</button> },
    ];
    ...
    return (
        <div className="space-y-6">
            ...
            <DataTable data={evaluations} columns={colonnes} searchable searchPlaceholder="Rechercher une évaluation..." />
        </div>
    );
}
