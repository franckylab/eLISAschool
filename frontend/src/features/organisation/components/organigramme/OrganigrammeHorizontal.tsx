/**
 * ==================================
 * eLISAschool - Organigramme Horizontal (Left-Right)
 * ==================================
 * Version: 1.0.0
 * Auteur: franck arlos chendjou
 *
 * Vue React Flow avec layout horizontal (left-to-right).
 */
...
interface OrganigrammeHorizontalProps {
...
function OrganigrammeHorizontalInner({ data, onNodeSelect, isEditMode, onEditUnite, onAddChildUnite, onDeleteUnite }: OrganigrammeHorizontalProps) {
    ...
    return (
        <div
            ...
            id="organigramme-flow-container-h"
...
export function OrganigrammeHorizontal(props: OrganigrammeHorizontalProps) {
    return (
        <ReactFlowProvider>
            <OrganigrammeHorizontalInner {...props} />
        </ReactFlowProvider>
    );
}
