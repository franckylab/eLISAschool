        ...
        >
            <div className="flex items-start gap-2">
                <button
                    {...attributes}
                    {...listeners}
                    className="mt-0.5 shrink-0 cursor-grab touch-none rounded p-0.5 text-gray-300 hover:bg-gray-100 hover:text-gray-500 transition-colors active:cursor-grabbing"
                >
                ...
                <div className="min-w-0 flex-1">
                    ...
                    {affectation.matiere?.code && (
                        <span className="ml-5 font-mono text-xs text-gray-400">{affectation.matiere.code}</span>
                    )}
                    <div className="ml-5 mt-1.5 flex flex-wrap items-center gap-3 text-xs text-gray-500">
        ...
        <div className="flex w-72 shrink-0 flex-col rounded-xl border border-gray-200 bg-gray-50">
            <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-gray-800">{column.nom}</span>
                </div>
            </div>
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <p className="text-sm text-gray-500">
                    ...
                    <span className="ml-2 text-xs text-gray-400">(glissez-déposez entre les colonnes)</span>
                </p>
            ...
            {columns.length === 0 ? (
                <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 bg-white py-16">
                    ...
                    <p className="font-medium text-gray-600">Aucune matière assignée</p>
                    <p className="mt-1 text-sm text-gray-500">Glissez des matières depuis le tableau ou ajoutez-en une.</p>
                </div>
            ) : (
                <DndContext
                    sensors={sensors}
                ...
                >
                    ...
                    <DragOverlay>
                        {activeAffectation ? (
                            <div className="w-72 rounded-lg border border-blue-300 bg-white shadow-xl">
