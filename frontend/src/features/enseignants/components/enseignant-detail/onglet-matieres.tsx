                    ...
                    <div className="flex overflow-hidden rounded-lg border border-gray-200">
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-1.5 text-sm transition-colors ${
                                mode === 'table' ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-500 hover:bg-gray-50'
                            }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-1.5 text-sm transition-colors ${
                                mode === 'kanban' ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-500 hover:bg-gray-50'
                            }`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-1.5 text-sm transition-colors ${
                                mode === 'planning' ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-500 hover:bg-gray-50'
                            }`}
                        >
