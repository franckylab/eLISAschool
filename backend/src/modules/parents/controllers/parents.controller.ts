/**
 * ==================================
 * eLISAschool - Controller Parents (Module Parents)
 * ==================================
 * Version: 1.0.0
...
import { ParentService, PortalParentService } from '../services';
...
/**
 * GET /api/parents/eleve/:enfantId/parents
...
/**
 * GET /api/parents/parent/:parentId/enfants
...
/**
 * PATCH /api/parents/:parentId/:enfantId
...
/**
 * DELETE /api/parents/:parentId/:enfantId
...
/**
 * GET /api/parents/verifier-acces/:eleveId
...
/**
 * GET /api/parents/portal/dashboard
...
/**
 * GET /api/parents/portal/enfants
...
/**
 * GET /api/parents/portal/enfant/:enfantId/notes
...
/**
 * GET /api/parents/portal/enfant/:enfantId/bulletins
...
/**
 * GET /api/parents/portal/enfant/:enfantId/cantine
...
/**
 * GET /api/parents/portal/enfant/:enfantId/transport
...
/**
 * GET /api/parents/portal/enfant/:enfantId/paiements
...
export const parentController = router;
