...
export const WIDGET_REGISTRY: WidgetDefinition[] = [
    ...
    // ==================================
    {
        ...
        type: 'stats-cards',
        roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.CHEF_ETABLISSEMENT, Role.SCOLARITE],
        permissions: ['eleves:view', 'eleves:statistiques:view'],
        dataResolver: 'elevesService.getDashboardStats',
    ...
    },
    {
        ...
        dataResolver: 'elevesService.getRepartitionParClasse',
        cacheTTL: 600,
        refreshStrategy: 'interval',
        etablissementScope: true,
        module: 'eleves',
    ...
    },
    {
        ...
        dataResolver: 'elevesService.getDernieresInscriptions',
        cacheTTL: 120,
        refreshStrategy: 'interval',
        etablissementScope: true,
        module: 'eleves',
    ...
    // ==================================
    {
        ...
        type: 'chart-line',
        roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.CHEF_ETABLISSEMENT, Role.ENSEIGNANT, Role.SCOLARITE],
        permissions: ['notes:view', 'notes:statistiques:view'],
        dataResolver: 'notesService.getMoyennesParPeriode',
        cacheTTL: 600,
        refreshStrategy: 'interval',
        etablissementScope: true,
        module: 'notes',
    ...
    },
    {
        ...
        dataResolver: 'notesService.getDernieresNotes',
        cacheTTL: 180,
        refreshStrategy: 'interval',
        etablissementScope: true,
        module: 'notes',
    ...
    },
    {
        ...
        roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.CHEF_ETABLISSEMENT, Role.ENSEIGNANT],
        permissions: ['notes:view', 'notes:statistiques:view'],
        dataResolver: 'notesService.getRepartitionNotes',
        cacheTTL: 600,
        refreshStrategy: 'interval',
        etablissementScope: true,
        module: 'notes',
    ...
    // ==================================
    {
        ...
        dataResolver: 'monitoringService.getHealthWidgets',
        cacheTTL: 60,
        refreshStrategy: 'interval',
    ...
    },
    {
        ...
        dataResolver: 'monitoringService.getUtilisateursStats',
        cacheTTL: 300,
        refreshStrategy: 'interval',
        etablissementScope: false,
        module: 'monitoring',
    ...
    // ==================================
    {
        ...
        type: 'stats-cards',
        roles: [Role.SUPER_ADMIN, Role.ADMIN, Role.CHEF_ETABLISSEMENT, Role.SCOLARITE, Role.ENSEIGNANT],
