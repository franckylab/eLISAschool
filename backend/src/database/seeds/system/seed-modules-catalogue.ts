...
const MODULES_CATALOGUE_COMPLET = [
    ...
    {
        code: 'annees-scolaires', nom: 'Années Scolaires', nomEn: 'School Years',
        description: 'Gestion des années scolaires : création, activation, clôture, workflow',
        categorie: CategorieModule.PAYANT, icone: 'Calendar',
        prixMensuel: 0, prixAnnuel: 0,
        estFacturable: false, estSouscriptible: false, actifParDefaut: true,
        planMinimal: 'starter', dependencies: [], ordre: 9, estSysteme: false,
        config: { requireValidation: false, transitionAuto: false },
    },
    {
        code: 'periodes', nom: 'Périodes', nomEn: 'Periods',
        description: 'Périodes de périodicité : trimestres, semestres, séquences',
        categorie: CategorieModule.PAYANT, icone: 'CalendarDays',
        prixMensuel: 0, prixAnnuel: 0,
        estFacturable: false, estSouscriptible: false, actifParDefaut: true,
        planMinimal: 'starter', dependencies: ['annees-scolaires'], ordre: 9, estSysteme: false,
        config: { transitionAuto: false },
    },
    {
