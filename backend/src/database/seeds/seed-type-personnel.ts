...
const TYPES_PAR_DEFAUT: Array<Partial<TypePersonnel>> = [
    { code: 'ENSEIGNANT', nom: 'Enseignant', modeRemunerationDefaut: 'MIXTE', actif: true },
    { code: 'DIRECTION', nom: 'Direction', modeRemunerationDefaut: 'MENSUEL', actif: true },
    { code: 'ADMINISTRATIF', nom: 'Administratif', modeRemunerationDefaut: 'MENSUEL', actif: true },
    { code: 'TECHNIQUE', nom: 'Technique', modeRemunerationDefaut: 'HORAIRE', actif: true },
    { code: 'SERVICE', nom: 'Service', modeRemunerationDefaut: 'HORAIRE', actif: true },
    { code: 'STAGE', nom: 'Stagiaire', modeRemunerationDefaut: 'STAGE', actif: true },
    { code: 'TEMPORAIRE', nom: 'Temporaire', modeRemunerationDefaut: 'HORAIRE', actif: true },
    { code: 'AUTRE', nom: 'Autre', modeRemunerationDefaut: 'MENSUEL', actif: true },
];
